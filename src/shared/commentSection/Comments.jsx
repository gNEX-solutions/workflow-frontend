                ...
                <div className="commentSection">
                    ...
                    <div className="row comment-area-block">
                        <div className="col-sm-10 form-group basic-textarea rounded-corners comment-text-block">
                            <textarea className="form-control z-depth-1" id="comment-text-area" rows="1" placeholder="Write your comment..."/>
                        </div>
                        <button type="button" className="col-sm-2 btn btn-light sendbtn">Send</button>
                    </div>
                </div>
            </React.Fragment>
        );
